...
# IMPORTANT:  winlocation.ps1 should be running (or you an manually edit the location.txt file with the local position)
...
geo = Geodesic.WGS84.Inverse(float(args.lat), float(args.lon), localGps.latitude, localGps.longitude)
...
print(formatStr.format("Bearing", azimuth))
